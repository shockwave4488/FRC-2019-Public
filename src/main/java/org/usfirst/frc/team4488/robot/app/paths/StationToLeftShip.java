...
public class StationToLeftShip implements PathContainer {
  ...
  public Path buildPath() {
    ...
    */
    ...
    double offset = (SubsystemManager.getInstance().getSelectedSide()) == Sides.Red ? Constants.leftRedEndOffset : Constants.leftBlueEndOffset;
