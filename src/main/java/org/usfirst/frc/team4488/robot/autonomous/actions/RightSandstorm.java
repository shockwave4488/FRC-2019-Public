...
import org.usfirst.frc.team4488.robot.app.paths.RightShipToStationPath;
import org.usfirst.frc.team4488.robot.app.paths.StationToLeftShip;
import org.usfirst.frc.team4488.robot.app.paths.StationToRightShip;
import org.usfirst.frc.team4488.robot.autonomous.actions.SideCargoScoreLine.Targets;

public class RightSandstorm implements Action {

  private Action routine;

  public RightSandstorm() {
    ...
    driveAndRotateTurret.add(new DrivePathUntilCamera(new RightShipToStationPath()));
    ...
    driveAndSetupArm.add(new RebuildAndDrivePathAction(new StationToRightShip()));
    ...
    driveAndSetupArm.add(new WaitAndTurnTurretToField(270, 5, 500));
