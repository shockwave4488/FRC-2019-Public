...
public class Drive extends DriveBase implements TankDrive {
  ...
  private final double speedDeadzone = 0.1;
  private final double turnDeadzone = 0.1;
  private DriveHelper driveHelper =
      new DriveHelper(this, speedDeadzone, turnDeadzone);
