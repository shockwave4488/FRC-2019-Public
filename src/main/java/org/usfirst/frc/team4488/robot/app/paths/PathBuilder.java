...
import org.usfirst.frc.team4488.lib.util.app.control.PathSegment;
...
public class PathBuilder {
  ...
  static class Arc {
    ...
    private static Translation2d intersect(Line l1, Line l2) {
      final RigidTransform2d lineA =
          new RigidTransform2d(l1.end, new Rotation2d(l1.slope, true).normal());
      final RigidTransform2d lineB =
          new RigidTransform2d(l2.start, new Rotation2d(l2.slope, true).normal());
