...
public class AdaptivePurePursuitController {
  ...
  public Command update(RigidTransform2d pose) {
    ...
    SmartDashboard.putNumber("Remaining Distance", report.remaining_path_distance);
  ...
  public static Translation2d getCenter(RigidTransform2d pose, Translation2d point) {
    ...
    final RigidTransform2d normalFromPose =
        new RigidTransform2d(pose.getTranslation(), pose.getRotation().normal());
  ...
  public static double getLength(
      RigidTransform2d pose, Translation2d point, Translation2d center, double radius) {
