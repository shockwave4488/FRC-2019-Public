...
// @TODO Change to Gyro Interface or GyroBase when new WPI comes out
...
public interface GyroscopeDrive extends TankDrive {
  ...
  public interface DynamicGyroscopeDelegate {
    public boolean drive(GyroBase gyro); // Change to Gyro Interface or
    // GyroBase when new WPI comes
    // out
  }

  public GyroBase getGyroscope();

  public default void turnToAngle(double power, double angle, boolean brake, double interval)
  ...
  public default void turnToAngle(double power, double angle, boolean brake)
      throws InterruptedException {
    turnToAngle(power, angle, brake, 0.02);
  }

  public default void turnForAngle(double power, double angle, boolean brake, double interval)
      throws InterruptedException {
    turnToAngle(power, angle + getGyroscope().getAngle(), brake, interval);
  }

  public default void turnForAngle(double power, double angle, boolean brake)
      throws InterruptedException {
    turnForAngle(power, angle, brake, 0.02);
  }

  public default void turnToAngle(
      MotionController controller, double angle, double tolerance, boolean brake, double interval)
      throws InterruptedException {
  ...
  public default void turnToAngle(
      MotionController controller, double angle, double tolerance, boolean brake)
      throws InterruptedException {
    turnToAngle(controller, angle, tolerance, brake, 0.02);
  }

  public default void turnForAngle(
      MotionController controller, double angle, double tolerance, boolean brake, double interval)
      throws InterruptedException {
  ...
  public default void driveStraightForTime(
      MotionController correction, double power, double time, boolean brake, double interval)
      throws InterruptedException {
  ...
  public default void driveStraightForTime(
      MotionController correction, double power, double time, boolean brake)
      throws InterruptedException {
    driveStraightForTime(correction, power, time, brake, 0.02);
  }

  public default void dynamicGyroscopeDrive(DynamicDriveDelegate expression, double interval)
      throws InterruptedException {
  ...
  public default void dynamicGyroscopeDrive(DynamicDriveDelegate expression)
      throws InterruptedException {
    dynamicGyroscopeDrive(expression, 0.02);
  }

  public default void dynamicGyroscopeDrive(DynamicGyroscopeDelegate expression, double interval)
      throws InterruptedException {
  ...
  public default void dynamicGyroscopeDrive(DynamicGyroscopeDelegate expression)
      throws InterruptedException {
    dynamicGyroscopeDrive(expression, 0.02);
  }
}
