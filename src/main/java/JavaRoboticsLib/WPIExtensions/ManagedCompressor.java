...
public class ManagedCompressor extends Compressor {
  ...
  /**
   * Creates a new Managed Compressor, which will turn off when the voltage is below the specified
   * level.
   *
  ...
  /**
   * Manually Updates the compressor, turning it on or off if necessary. Called automatically
   * according to the period value if {@link #UseTimer} is enabled.
   */
  public void update() {
