...
public class EncoderExtension {
  /**
   * Sets {@link #DistancePerPulse} to the proper value given by diameter of a wheel and counts per
   * revolution
   *
   * @param wheelDiameter Diameter of the wheel. Units used here will determine units of {@link
   *     #GetRate}
