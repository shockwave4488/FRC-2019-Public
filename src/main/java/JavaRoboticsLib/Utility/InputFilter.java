...
public class InputFilter {
  private static final double[] ForewardCoefficients = {
    0.144426, 0.235649, 0.239850, 0.235649, 0.144426
  };
  ...
  public void reInitialize(double setTo) {
    ...
    for (int i = 0; i < m_internalState.length; i++) m_internalState[i] = setTo;
  }
