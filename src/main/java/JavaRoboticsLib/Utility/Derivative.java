...
public class Derivative {
  ...
  /**
   * The change in time for this particular Controller loop in seconds. Set to negative to determine
   * dt automatically.
   */
  ...
  public double get(double x) {
    ...
    // Handle division by zero errors, ignoring the input if there is no
    // change in time.
