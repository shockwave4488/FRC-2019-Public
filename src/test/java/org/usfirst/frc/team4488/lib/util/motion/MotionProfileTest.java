package org.usfirst.frc.team4488.lib.util.motion;
...
import org.usfirst.frc.team4488.lib.util.app.motion.MotionProfile;
import org.usfirst.frc.team4488.lib.util.app.motion.MotionSegment;
import org.usfirst.frc.team4488.lib.util.app.motion.MotionState;
...
public class MotionProfileTest {
  ...
  public void setUp() {
    ...
    segments.add(
        new MotionSegment(
            new MotionState(0.0, 0.0, 0.0, 1.0), new MotionState(1.0, 0.5, 1.0, 1.0)));
    // Cruise at 1 unit/s for 1 second
    segments.add(
        new MotionSegment(
            new MotionState(1.0, 0.5, 1.0, 0.0), new MotionState(2.0, 1.5, 1.0, 0.0)));
    ...
    segments_reversed.add(
        new MotionSegment(
            new MotionState(5.0, 0.5, -1.0, 1.0), new MotionState(6.0, 0.0, 0.0, 1.0)));
  ...
  public void isValid() {
    ...
    a.appendSegment(
        new MotionSegment(
            new MotionState(0.0, 0.0, 0.0, 0.0), new MotionState(0.0, 0.0, 0.0, 1.0)));
    assertFalse(a.isValid());

    a = new MotionProfile();
    a.appendSegment(
        new MotionSegment(
            new MotionState(0.0, 0.0, 0.0, 1.0), new MotionState(1.0, 0.0, 1.0, 1.0)));
    assertFalse(a.isValid());
  ...
  public void appendSegment() {
    ...
    a.appendSegment(
        new MotionSegment(
            new MotionState(3.0, 2.0, 0.0, 1.0), new MotionState(4.0, 2.5, 1.0, 1.0)));
    a.appendSegment(
        new MotionSegment(
            new MotionState(4.0, 2.5, 1.0, 0.0), new MotionState(5.0, 3.5, 1.0, 0.0)));
    a.appendSegment(
        new MotionSegment(
  ...
  public void firstStateByPos() {
    ...
    assertThat(
        a.firstStateByPos(1.0).get(),
        is(equalTo(segments_reversed.get(1).start().extrapolate(4.5))));
