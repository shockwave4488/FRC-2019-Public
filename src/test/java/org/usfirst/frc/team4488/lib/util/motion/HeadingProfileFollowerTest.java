...
import static org.usfirst.frc.team4488.lib.util.motion.MotionTestUtil.*;

import org.junit.Test;
import org.usfirst.frc.team4488.lib.util.app.motion.*;
import org.usfirst.frc.team4488.lib.util.app.motion.MotionProfileGoal.CompletionBehavior;
import org.usfirst.frc.team4488.lib.util.motion.MotionTestUtil.Dynamics;
import org.usfirst.frc.team4488.lib.util.motion.MotionTestUtil.IdealDynamics;
import org.usfirst.frc.team4488.lib.util.motion.MotionTestUtil.ScaledDynamics;
...
public class HeadingProfileFollowerTest {
  ...
  public void testStationaryToStationaryFeedforwardWrap() {
    ...
    MotionState start_state =
        new MotionState(0.0, -179.0, 0.0, 0.0); // -179 degrees (==181 degrees)
    final double dt = 0.01;
  ...
  public void testStationaryToStationaryFeedback() {
    ...
    MotionProfileGoal goal =
        new MotionProfileGoal(100.0, 0.0, CompletionBehavior.OVERSHOOT, 1.0, 1.0);
    ...
    MotionState final_state =
        followProfile(follower, new ScaledDynamics(start_state, .8), dt, 2000);
    assertTrue(goal.atGoalState(HeadingProfileFollower.canonicalize(final_state)));
  }
